...
<div>
  ...
  <div style="margin:0">
    <el-button class="ml-5" type="primary" @click="handleAdd">新增发布<i class="el-icon-circle-plus-outline"></i> </el-button>
    <el-popconfirm
        class="ml-5"
        title="确定批量删除这些数据吗？"
  ...
  <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
    ...
    <el-table-column prop="taskReleaser" label="任务发布者" width="120">
    </el-table-column>
    <el-table-column prop="fileSize" label="文件大小（kb）" width="120">
    </el-table-column>
    <el-table-column prop="profit" label="收益（分）" width="120">
    </el-table-column>
    ...
    <!-- <el-table-column label="操作" >
      <template slot-scope="scope">
        ...
        <el-popconfirm
            ...
            icon="el-icon-info"
            icon-color="red"
            @confirm="del(scope.row.taskName)"
        >
  ...
  <el-dialog title="新添发布任务" :visible.sync="dialogFormVisible" width="50%" >
    <el-form label-width="110px" size="small">
      <el-form-item label="任务名称名称">
