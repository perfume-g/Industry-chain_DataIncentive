<template>
  ...
  <div>
    <el-main>
        ...
        <el-table-column prop="taskReleaser" label="任务发布者" width="150">
        </el-table-column>
        <el-table-column prop="fileSize" label="文件大小（kb）" width="150">
        </el-table-column>
        <el-table-column prop="profit" label="收益（分）" width="150">
        </el-table-column>
        <el-table-column prop="year" label="年" width="100">
        </el-table-column>
        <el-table-column prop="month" label="月" width="80">
        </el-table-column>
        <el-table-column prop="day" label="日" width="80">
        </el-table-column>
        <el-table-column prop="chain" label="所属产业链" width="120">
        </el-table-column>
